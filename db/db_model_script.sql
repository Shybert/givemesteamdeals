...
CREATE TABLE IF NOT EXISTS `gamesdb`.`app` (
  ...
  `is_package` TINYINT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `gamesdb`.`package`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamesdb`.`package` (
...
-- -----------------------------------------------------
-- Table `gamesdb`.`price_track`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamesdb`.`price_track` (
  `pricel_track_id` INT NOT NULL AUTO_INCREMENT,
  `app_steam_id` VARCHAR(7) NOT NULL,
  `tracked_price` VARCHAR(7) NULL,
  `email` VARCHAR(100) NULL,
  `user_name` VARCHAR(100) NULL,
  PRIMARY KEY (`pricel_track_id`),
  INDEX `fk_deal_track_app1_idx` (`app_steam_id` ASC),
  CONSTRAINT `fk_deal_track_app1`
    FOREIGN KEY (`app_steam_id`)
    REFERENCES `gamesdb`.`app` (`steam_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
